...
object Dependencies {
  ...
  lazy val hadoopMapreduceClientApp: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce-client-app" % hadoopVersion)
  lazy val hadoopMapreduceClientCommon: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce-client-common" % hadoopVersion)
  lazy val hadoopMapreduceClientJobClient: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce-client-jobclient" % hadoopVersion)
  lazy val hadoopMapreduceClientShuffle: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce-client-shuffle" % hadoopVersion)
  lazy val hadoopMapReduce: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce" % hadoopVersion)
  lazy val hadoopMapReduceClient: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce-client" % hadoopVersion)
  lazy val hadoopMapReduceClientCore: ModuleID = hiveExcludes("org.apache.hadoop" % "hadoop-mapreduce-client-core" % hadoopVersion)
...
trait Dependencies {
  ...
  val kafkaConnectHbaseDeps : Seq[ModuleID] = Seq(nettyAll, hadoopCommon, hadoopHdfs, hadoopHdfsClient, hbaseClient, nimbusJoseJwt)

  val kafkaConnectHbaseTestDeps : Seq[ModuleID] = baseTestDeps ++ Seq()

  val kafkaConnectHiveDeps : Seq[ModuleID] = Seq(nettyAll, parquetAvro, parquetColumn, parquetEncoding, parquetHadoop, parquetHadoopBundle, joddCore, hiveJdbc, hiveExec, hadoopCommon, hadoopAuth, hadoopHdfs, hadoopHdfsClient, hadoopMapReduce, hadoopMapReduceClient, hadoopMapReduceClientCore,  hadoopClient, hadoopDistCp, hadoopMapreduceClientApp, hadoopMapreduceClientCommon, hadoopMapreduceClientJobClient, hadoopMapreduceClientShuffle, nimbusJoseJwt)
